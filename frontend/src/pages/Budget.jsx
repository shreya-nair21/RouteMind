      ...
      <div className="max-w-6xl mx-auto animate-fade-in space-y-12 pb-20">
         <div className="flex flex-col sm:flex-row gap-4 justify-between sm:items-end border-b border-white/10 pb-10">
            <div>
               ...
               <h1 className="text-3xl md:text-5xl font-extrabold tracking-tighter text-white uppercase">Budget Analytics</h1>
            </div>
            ...
            <div className="lg:col-span-2 space-y-8">
               <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  ...
                  <div className="bg-surface border border-white/10 p-6 rounded-xl shadow-sm">
                     ...
                     <h3 className="text-3xl text-white tracking-tight">₹{Math.max(0, remaining).toLocaleString()}</h3>
                     <div className="mt-6 flex items-center gap-2">
               ...
               <div className="w-full h-64">
                  <ResponsiveContainer width="100%" height="100%">
                     <PieChart>
                        ...
                        <Tooltip 
                           contentStyle={{ borderRadius: '8px', backgroundColor: '#0F172A', border: '1px solid rgba(255,255,255,0.1)', color: '#FFFFFF' }} 
                        ...
                        <Legend 
                           ...
                           height={36} 
                           iconType="circle" 
                           formatter={(value) => <span className="text-white text-xs font-semibold">{value}</span>}
                        />
                     </PieChart>
                  </ResponsiveContainer>
               </div>
