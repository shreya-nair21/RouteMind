      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
         ...
         <div className="md:col-span-2 space-y-8">
            <div className="bg-surface border border-white/10 p-6 rounded-xl shadow-sm space-y-6">
               <h3 className="text-xs font-bold uppercase tracking-wider text-secondary border-b border-white/10 pb-3">Account Integrity</h3>
               
               <div className="space-y-4">
                  <div className="space-y-1.5">
                     <label className="text-[9px] font-bold text-slate-400 uppercase tracking-widest ml-1">Access Email</label>
                     <p className="pro-input h-12 flex items-center bg-zinc-950 border border-white/5 font-medium text-slate-300 text-sm">{user?.email}</p>
                  </div>
